...
(function(){
	...
	Chart.defaults = {
		global: {
            ...
            // String - append to the end of the y axis label
            yAxisUnit: '',
	...
	Chart.Scale = Chart.Element.extend({
		...
		buildYLabels : function(){
            ...
            // + 3 - work around for the first char cutted problem
			this.yLabelWidth = (this.display && this.showLabels) ? longestText(this.ctx,this.font,this.yLabels) + longestText(this.ctx,this.font,[this.yAxisUnit]) + 3 : 0;
		},
		...
		draw : function(){
			...
			if (this.display){
				...
				each(this.yLabels,function(labelString,index){
					...
					ctx.textBaseline = "middle";
					if (this.showLabels){
                        labelString = labelString + this.yAxisUnit;
	...
	Chart.Type.extend({
		...
		buildScale : function(labels){
			...
			var scaleOptions = {
                ...
                yAxisUnit: (this.options.yAxisUnit) ? this.options.yAxisUnit : '',
